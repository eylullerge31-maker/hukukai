...
export const DOCUMENT_TEMPLATES: DocumentTemplate[] = [
  {
    ...
    fields: [
      ...
      { id: "d3", label: "Aylık Kira (₺)", type: "number", placeholder: "5000", showWhen: { fieldId: "d5", values: ["Kira Borcunun Ödenmesi", "Kira Artışı"] } },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "d2", label: "İşe Başlama Tarihi", type: "date", required: true },
      { id: "d3", label: "Ayrılış / İşten Çıkış Tarihi", type: "date" },
      { id: "d5", label: "Aylık Brüt Maaş (₺)", type: "number", placeholder: "15000", showWhen: { fieldId: "d4", values: ["Kıdem Tazminatı", "İhbar Tazminatı", "İşe İade", "Yıllık İzin Ücreti"] } },
      { id: "d6", label: "Fazla Mesai Saati / Gün", type: "text", placeholder: "Örn: 150 saat", showWhen: { fieldId: "d4", values: ["Fazla Mesai"] } },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "d2", label: "Ürün / Hizmet", type: "text", placeholder: "Ürün adı", showWhen: { fieldId: "d3", values: ["Ayıplı Ürün", "İade Reddi", "Garanti Kapsamı", "Yanıltıcı Reklam"] } },
      { id: "d4", label: "Talep Edilen Tutar (₺)", type: "number", placeholder: "2500", showWhen: { fieldId: "d3", values: ["Ayıplı Ürün", "İade Reddi", "Hizmet Yetersizliği"] } },
      { id: "d5", label: "Hizmet / Ürün Detayı", type: "textarea", placeholder: "Sorunun açıklaması...", showWhen: { fieldId: "d3", values: ["Hizmet Yetersizliği", "Yanıltıcı Reklam"] } },
    ],
  },
  {
    type: "borc",
